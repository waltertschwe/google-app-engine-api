...
require_once '/var/www/striplate/vendor/google/apiclient/src/Google/Client.php';
require_once '/var/www/striplate/vendor/google/apiclient/src/contrib/Google_Oauth2Service.php';


$google_client_id = "745205624787-kbs658c2dsq84o0dm49evshqid49mnem.apps.googleusercontent.com";
$google_client_secret = "AIzaSyD4fGAjRM_T1GgR2OLw4TcEUOWQtM_WYSY";
$google_redirect_url = "http://ec2-50-19-187-57.compute-1.amazonaws.com/stirplate/vendor/google/apiclient/examples/user-example.php";

$gClient = new Google_Client();
$gClient->setApplicationName('My First Project');
